            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-file-text-o"></i>Kawin Silang</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row container" style="padding: 30px;">
                                <div class="page-header">
                                    <h3>Permodelan Proses Kawin Silang <small>Position Based Crossover</small></h3>
                                </div>

                                <table class="display nowrap cell-border" cellspacing="0" width="100%" id="tcrossover">
                                    <thead>
                                    <tr>
                                        <th>id</th>
                                        <th>Generasi</th>
                           ...
                           <div class="row container" style="padding: 30px;">
                                <div class="page-header">
                                    <h3>Populasi Hasil Kawin Silang <small>Position Based Crossover</small></h3>
                                </div>
        ...
        $(document).ready(function() {
            $('#tcrossover').DataTable({
                ...
                "columns": [
                    ...
                    { "data": "co", "className" : "dt-body-center dt-head-center","render" : function ( data) {
                        if (data === 0) {
                    ...
                    { "data": "co" , "className" : "dt-body-right dt-head-center" }
                ],
                "columnDefs": [
                    {
                        "targets": [0,7],
            ...
            $('.kecamatan').change(function () {
                ...
                $('#tpopulasi').DataTable({
                    "ajax":  {
                        "url": '/crossover.filter2/' +  $(this).val() ,
                        "dataSrc": ""
                    },
                    "columns": [
                        { "data": "id" },
