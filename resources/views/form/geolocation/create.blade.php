                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('url' => 'geolocation','class' => 'form-horizontal','role' => 'form')) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::select('kecamatan', $selkec,Request::old('kecamatan'), array('class' => 'form-control')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::text('latitude', Request::old('latitude'), array('class' => 'form-control','placeholder'=>'Latitude','style' => 'text-align:left;width:150px;text-align:right')) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::text('longitude', Request::old('longitude'), array('class' => 'form-control','placeholder'=>'Longitude','style' => 'text-align:left;width:150px;text-align:right')) !!}
                                    </div>
                                </div>
