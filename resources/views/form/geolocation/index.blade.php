                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div align="right">
                                <a href="{{ URL::to('geolocation/create') }}" class="btn btn-primary" ><b><i class="fa fa-plus" aria-hidden="true"></i> Tambah</b></a>
                                ...
                                <a href="#" data-toggle="#" id="hapus" class="btn btn-danger" type="button" data-target="#konfirmHapus"  data-title="Hapus Lokasi" data-message="Anda yakin menghapus ?"><b><i class="fa fa-remove" aria-hidden="true"></i> Hapus</b></a>
                                {!! Form::close() !!}
                                <a href="#" id="mapper" class="btn btn-default" ><b><i class="fa fa-map-marker" aria-hidden="true"></i> Lokasi</b></a>
                            </div>


                            <table class="display nowrap cell-border" cellspacing="0" width="100%" id="tlokasi">
                                <thead>
                                <tr>
                                    <th>id</th>
                                    <th>Kode</th>
...
@section('js')
    ...
    <script type="text/javascript">
        var table = $('#tlokasi').DataTable({
            ...
            "columns": [
                {"data": "id"},
                {"data": "kdlokasi", "className": "dt-body-left dt-head-center"},
        ...
        $('#tlokasi tbody').on( 'click', 'tr', function () {
            ...
            $('#edit').click( function () {
                ...
                $(this).attr("href",'geolocation/' + idkonfig + '/edit');
            ...
            $('#hapus').click(function () {
                ...
                $('#frmhapus').attr("action",'geolocation/' + idkonfig);
            });
            ...
            $('#mapper').click( function () {
                ...
                $(this).attr("href",'geolocation/' + idkonfig);
