                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::model($kapasitas, array('route' => array('kapasitas.update', $kapasitas->id),'class' => 'form-horizontal', 'method' => 'PUT')) !!}
                            <div class="form-group">
                                <div class="col-md-4" align="right">
                                    {!! Form::label('model', 'Model',array('class' => 'control-label')) !!}
                                </div>
                                <div class="col-md-6">
                                    {!! Form::text('model', $kapasitas->model, array('class' => 'form-control','readonly','placeholder' => 'model-no','style' => 'text-align:left;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('bandwidth', $kapasitas->bw, array('class' => 'form-control','placeholder' => '0','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('qpsk', $kapasitas->qpsk, array('class' => 'form-control','placeholder' => '0','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('qam16', $kapasitas->qam16, array('class' => 'form-control','placeholder' => '0','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('qam64', $kapasitas->qam64, array('class' => 'form-control','placeholder' => '0','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
