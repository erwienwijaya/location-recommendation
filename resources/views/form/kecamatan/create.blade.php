                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('url' => 'kecamatan','class' => 'form-horizontal','role' => 'form')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('kecamatan', Request::old('kecamatan'), array('class' => 'form-control','placeholder'=>'Kecamatan')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('kategori', $selkategori,Request::old('kategori'), array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('luas', Request::old('luas'), array('class' => 'form-control','placeholder'=>'Luas','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
