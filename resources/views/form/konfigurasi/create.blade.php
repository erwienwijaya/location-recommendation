                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(array('url' => 'konfigurasi','class' => 'form-horizontal','role' => 'form')) !!}
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                      <div class='input-group date' id='datetimepicker1' style='text-align:right;width:150px'>
                                          {!! Form::text('tahun', Request::old('tahun'), array('class' => 'form-control','placeholder' => 'tahun','style' => 'text-align:center;')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('kota', $selkota,Request::old('kota'), array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::select('kecamatan', $selkecamatan,Request::old('kecamatan'), array('class' => 'form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('jumlah', Request::old('jumlah'), array('class' => 'form-control','placeholder'=>'Jumlah Penduduk','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('kepadatan', Request::old('kepadatan'), array('class' => 'form-control','placeholder'=>'Kepadatan','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('site', Request::old('site'), array('class' => 'form-control','placeholder'=>'Site','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('prakiraan', Request::old('prakiraan'), array('class' => 'form-control','placeholder'=>'Prakiraan','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('latitude', Request::old('latitude'), array('class' => 'form-control','placeholder'=>'Latitude','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    {!! Form::text('longitude', Request::old('longitude'), array('class' => 'form-control','placeholder'=>'Longitude','style' => 'text-align:right;width:150px')) !!}
                                </div>
                            </div>
