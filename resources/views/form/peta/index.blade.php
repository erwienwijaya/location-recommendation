                            ...
                            <div class="row container">
                                <div class="col-xs-12 col-sm-6 col-md-8">
                                    <div class='form-group'>
                                        <label for="plhkecamatan" class="col-sm-2 control-label"><b>Kecamatan</b></label>
                                        {!! Form::select('model',[0 => 'Pilih Kecamatan'] + $selkec,null,['class' => 'form-control col-sm-10 kecamatan','style' => 'width:200px;']) !!}
                                        <button class="btn btn-primary" id = "btndetil" style="font-weight: bold;"><i class="fa fa-binoculars" aria-hidden="true"></i> Detil</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function initMap() {
                var map = new google.maps.Map(document.getElementById('map'), {
                    zoom: 13,
                    center: new google.maps.LatLng(-7.967079, 112.632466),
                ...
                $.getJSON('/peta.data' ,function(locations) {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btndetil').click(function() {
                if ($('.kecamatan').val() != 0) {
                    location.href='/detil/' + $('.kecamatan').val();
                }
            });
        });
    </script>
